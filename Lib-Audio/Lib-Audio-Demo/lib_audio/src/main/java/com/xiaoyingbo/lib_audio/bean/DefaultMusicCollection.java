...
package com.xiaoyingbo.lib_audio.bean;
...
public class DefaultMusicCollection extends BaseMusicCollectionItem<
        DefaultMusicCollection.DefaultMusic,
        DefaultMusicCollection.DefaultArtist> {

  public static class DefaultMusic extends BaseMusicItem<DefaultArtist> {

  }

  public static class DefaultArtist extends BaseAuthorItem {
