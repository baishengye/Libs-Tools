...
import com.xiaoyingbo.lib_architecture.ui.page.dataBindingPage.DataBindingDialogFragment
import com.xiaoyingbo.lib_architecture.ui.scope.ViewModelScope

abstract class BaseDialogFragment<B : ViewDataBinding> : DataBindingDialogFragment<B>() {
