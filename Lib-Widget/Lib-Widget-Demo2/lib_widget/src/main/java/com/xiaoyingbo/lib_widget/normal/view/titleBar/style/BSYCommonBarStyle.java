...
import com.xiaoyingbo.lib_widget.normal.view.titleBar.BSYITitleBarStyle;
import com.xiaoyingbo.lib_widget.normal.view.titleBar.BSYTitleBarSupport;

/**
 *    desc   : 默认初始化器基类
 */
public abstract class BSYCommonBarStyle implements BSYITitleBarStyle {
    ...
    public Typeface getTitleTypeface(Context context, int style) {
        return BSYTitleBarSupport.getTextTypeface(style);
    }
