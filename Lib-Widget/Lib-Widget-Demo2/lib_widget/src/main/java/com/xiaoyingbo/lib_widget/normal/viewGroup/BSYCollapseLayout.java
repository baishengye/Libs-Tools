...
public class BSYCollapseLayout extends FrameLayout {
	...
	public BSYCollapseLayout(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.BSYCollapseLayout, defStyle, 0);
		setCollapseOrientation(Orientation.values()[a.getInt(R.styleable.BSYCollapseLayout_collapseOrientation, 0)]);
		setCollapseMode(CollapseMode.values()[a.getInt(R.styleable.BSYCollapseLayout_collapseMode, 0)]);
		state = State.values()[a.getInt(R.styleable.BSYCollapseLayout_state, 0)];
		setAnimateDuration(a.getInt(R.styleable.BSYCollapseLayout_collapseDuration, DEFAULT_ANIM_TIME));
		a.recycle();
	...
	public BSYCollapseLayout(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
	}

	public BSYCollapseLayout(Context context) {
		this(context, null);
	}
