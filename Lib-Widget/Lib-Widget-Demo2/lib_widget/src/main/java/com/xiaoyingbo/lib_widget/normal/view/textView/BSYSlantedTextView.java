...
public final class BSYSlantedTextView extends View {
    ...
    public BSYSlantedTextView(Context context) {
        this(context, null);
    }

    public BSYSlantedTextView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public BSYSlantedTextView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray array = context.obtainStyledAttributes(attrs, R.styleable.BSYSlantedTextView);

        setText(array.getString(R.styleable.BSYSlantedTextView_android_text));
        setTextSize(TypedValue.COMPLEX_UNIT_PX, array.getDimensionPixelSize(R.styleable.BSYSlantedTextView_android_textSize, (int) getResources().getDimension(R.dimen.sp_12)));
        setTextColor(array.getColor(R.styleable.BSYSlantedTextView_android_textColor, Color.WHITE));
        setTextStyle(Typeface.defaultFromStyle(array.getInt(R.styleable.BSYSlantedTextView_android_textStyle, Typeface.NORMAL)));
        setGravity(array.getInt(R.styleable.BSYSlantedTextView_android_gravity, Gravity.END));
        setColorBackground(array.getColor(R.styleable.BSYSlantedTextView_android_colorBackground, getAccentColor()));
        setTriangle(array.getBoolean(R.styleable.BSYSlantedTextView_triangle, false));
