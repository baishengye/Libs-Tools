...
public class DialogFragmentDetector extends Detector implements SourceCodeScanner {
    ...
    public static final Issue ISSUE = Issue.create(
            ...
            new Implementation(DialogFragmentDetector.class, Scope.JAVA_FILE_SCOPE));
