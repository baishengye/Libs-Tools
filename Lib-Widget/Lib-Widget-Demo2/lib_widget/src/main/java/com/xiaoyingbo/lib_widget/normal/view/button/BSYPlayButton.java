 ...
 *    desc   : 播放暂停动效的按钮
 */
public final class BSYPlayButton extends View {
    ...
    public BSYPlayButton(Context context) {
        this(context, null);
    }

    public BSYPlayButton(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public BSYPlayButton(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);

        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.BSYPlayButton);
        int lineColor = typedArray.getColor(R.styleable.BSYPlayButton_pb_lineColor, Color.WHITE);
        int lineSize = typedArray.getInteger(R.styleable.BSYPlayButton_pb_lineSize, (int) getResources().getDimension(R.dimen.dp_4));
        mAnimDuration = typedArray.getInteger(R.styleable.BSYPlayButton_pb_animDuration, 200);
        typedArray.recycle();
