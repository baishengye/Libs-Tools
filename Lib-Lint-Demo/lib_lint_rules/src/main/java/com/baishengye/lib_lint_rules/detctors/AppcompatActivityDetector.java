...
public class AppcompatActivityDetector extends Detector implements SourceCodeScanner {
    ...
    public static final Issue ISSUE = Issue.create(
            ...
            new Implementation(AppcompatActivityDetector.class, Scope.JAVA_FILE_SCOPE));
