 ...
 * BSYSwitchButton.
 */
public class BSYSwitchButton extends View implements Checkable{
    ...
    public BSYSwitchButton(Context context) {
        super(context);
        init(context, null);
    }

    public BSYSwitchButton(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public BSYSwitchButton(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context, attrs);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public BSYSwitchButton(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if(attrs != null){
            typedArray = context.obtainStyledAttributes(attrs, R.styleable.BSYSwitchButton);
        }

        shadowEffect = optBoolean(typedArray,
                R.styleable.BSYSwitchButton_switch_shadow_effect,
                true);

        uncheckCircleColor = optColor(typedArray,
                R.styleable.BSYSwitchButton_switch_uncheckcircle_color,
                0XffAAAAAA);//0XffAAAAAA;

        uncheckCircleWidth = optPixelSize(typedArray,
                R.styleable.BSYSwitchButton_switch_uncheckcircle_width,
                dp2pxInt(1.5f));//dp2pxInt(1.5f);

        uncheckCircleOffsetX = dp2px(10);

        uncheckCircleRadius = optPixelSize(typedArray,
                R.styleable.BSYSwitchButton_switch_uncheckcircle_radius,
                dp2px(4));//dp2px(4);
        ...
        shadowRadius = optPixelSize(typedArray,
                R.styleable.BSYSwitchButton_switch_shadow_radius,
                dp2pxInt(2.5f));//dp2pxInt(2.5f);

        shadowOffset = optPixelSize(typedArray,
                R.styleable.BSYSwitchButton_switch_shadow_offset,
                dp2pxInt(1.5f));//dp2pxInt(1.5f);

        shadowColor = optColor(typedArray,
                R.styleable.BSYSwitchButton_switch_shadow_color,
                0X33000000);//0X33000000;

        uncheckColor = optColor(typedArray,
                R.styleable.BSYSwitchButton_switch_uncheck_color,
                0XffDDDDDD);//0XffDDDDDD;

        checkedColor = optColor(typedArray,
                R.styleable.BSYSwitchButton_switch_checked_color,
                0Xff51d367);//0Xff51d367;

        borderWidth = optPixelSize(typedArray,
                R.styleable.BSYSwitchButton_switch_border_width,
                dp2pxInt(1));//dp2pxInt(1);

        checkLineColor = optColor(typedArray,
                R.styleable.BSYSwitchButton_switch_checkline_color,
                Color.WHITE);//Color.WHITE;

        checkLineWidth = optPixelSize(typedArray,
                R.styleable.BSYSwitchButton_switch_checkline_width,
                dp2pxInt(1f));//dp2pxInt(1.0f);

        checkLineLength = dp2px(6);

        int buttonColor = optColor(typedArray,
                R.styleable.BSYSwitchButton_switch_button_color,
                Color.WHITE);//Color.WHITE;
        
        uncheckButtonColor = optColor(typedArray,
                R.styleable.BSYSwitchButton_switch_uncheckbutton_color,
                buttonColor);

        buttonRadiusScale = optFloat(typedArray,
                R.styleable.BSYSwitchButton_switch_buttonRadiusScale,
                1.0F);
    
        checkedButtonColor = optColor(typedArray,
                R.styleable.BSYSwitchButton_switch_checkedbutton_color,
                buttonColor);

        int effectDuration = optInt(typedArray,
                R.styleable.BSYSwitchButton_switch_effect_duration,
                300);//300;

        isChecked = optBoolean(typedArray,
                R.styleable.BSYSwitchButton_switch_checked,
                false);

        showIndicator = optBoolean(typedArray,
                R.styleable.BSYSwitchButton_switch_show_indicator,
                true);

        background = optColor(typedArray,
                R.styleable.BSYSwitchButton_switch_background,
                Color.WHITE);//Color.WHITE;

        enableEffect = optBoolean(typedArray,
                R.styleable.BSYSwitchButton_switch_enable_effect,
                true);
    ...
    private void drawButton(Canvas canvas, float x, float y) {
        canvas.drawCircle(x, y, buttonRadius*buttonRadiusScale, buttonPaint);

        paint.setStyle(Paint.Style.STROKE);
        paint.setStrokeWidth(1);
        paint.setColor(0XffDDDDDD);
        canvas.drawCircle(x, y, buttonRadius*buttonRadiusScale, paint);
    }
     ...
     */
    public BSYSwitchButton setShadowEffect(boolean shadowEffect) {
        if(this.shadowEffect == shadowEffect){return this;}
    ...
    public BSYSwitchButton setEnableEffect(boolean enable){
        this.enableEffect = enable;
        return this;
    }

    public BSYSwitchButton setShadowRadius(int shadowRadius){
        this.shadowRadius = shadowRadius;
        return this;
    }

    public BSYSwitchButton setShadowOffset(int shadowOffset) {
        this.shadowOffset = shadowOffset;
        return this;
    }

    public BSYSwitchButton setShadowColor(int shadowColor) {
        this.shadowColor = shadowColor;
        return this;
    }

    public BSYSwitchButton setUncheckColor(int uncheckColor) {
        this.uncheckColor = uncheckColor;
        return this;
    }

    public BSYSwitchButton setCheckedColor(int checkedColor) {
        this.checkedColor = checkedColor;
        return this;
    }

    public BSYSwitchButton setBorderWidth(int borderWidth){
        this.borderWidth = borderWidth;
        return this;
    }

    public BSYSwitchButton setCheckLineColor(int checkLineColor) {
        this.checkLineColor = checkLineColor;
        return this;
    }

    public BSYSwitchButton setCheckLineWidth(int checkLineWidth) {
        this.checkLineWidth = checkLineWidth;
        return this;
    }

    public BSYSwitchButton setUncheckCircleColor(int uncheckCircleColor) {
        this.uncheckCircleColor = uncheckCircleColor;
        return this;
    }

    public BSYSwitchButton setUncheckCircleWidth(int uncheckCircleWidth) {
        this.uncheckCircleWidth = uncheckCircleWidth;
        return this;
    }

    public BSYSwitchButton setUncheckCircleRadius(float uncheckCircleRadius) {
        this.uncheckCircleRadius = uncheckCircleRadius;
        return this;
    }

    public BSYSwitchButton setEffectDuration(int effectDuration){
        valueAnimator.setDuration(effectDuration);
        return this;
    }

    public BSYSwitchButton setShowIndicator(boolean showIndicator){
        this.showIndicator = showIndicator;
        return this;
    }

    public BSYSwitchButton setBackground(int background){
        this.background = background;
        return this;
    }

    public BSYSwitchButton setCheckedButtonColor(int checkedButtonColor){
        this.checkedButtonColor = checkedButtonColor;
        return this;
    }

    public BSYSwitchButton setUncheckButtonColor(int uncheckButtonColor){
        this.uncheckButtonColor = uncheckButtonColor;
        return this;
    }

    public BSYSwitchButton setButtonRadiusScale(float buttonRadiusScale){
        this.buttonRadiusScale = buttonRadiusScale;
        return this;
    }
    ...
    public interface OnCheckedChangeListener{
        void onCheckedChanged(BSYSwitchButton view, boolean isChecked);
    }
    ...
    private float buttonRadiusScale = 1.0F;
    /**
     *关闭圆圈线宽
     */
